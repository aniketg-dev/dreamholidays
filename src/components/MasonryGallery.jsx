      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
          {destinations.map((destination) => (
            <div
              key={destination.id}
              className={`${destination.height} relative group overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer break-inside-avoid`}
            >
              {/* Background Image */}
              <Image
