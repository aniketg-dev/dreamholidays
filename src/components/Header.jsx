...
const Header = () => {
  ...
  const socialPlatforms = siteContent?.social?.platforms || [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex justify-between items-center transition-all duration-300 ${
          ...
          <Link href="/" className="flex items-center">
            <Image
              src={company.logo || "/logo/cttlogo-bg.png"}
          ...
          <div className="hidden lg:flex items-center space-x-4 xl:space-x-6">
            {company.phone && (
              ...
              >
                ...
                <span className="font-medium text-sm xl:text-base">{company.phone}</span>
              </a>
            )}
            ...
            {company.email && (
              ...
              >
                ...
                <span className="font-medium text-sm xl:text-base hidden xl:inline">{company.email}</span>
            ...
            {socialPlatforms.length > 0 && (
              <div className="flex items-center space-x-3 border-l border-gray-300 pl-4 xl:pl-6">
                {socialPlatforms.map((platform, index) => {
                  if (platform.url === '#' || !platform.url) return null;
            ...
            <div className="flex flex-col space-y-4 px-2">
              ...
              {socialPlatforms.length > 0 && (
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-3 px-2">Follow Us</p>
